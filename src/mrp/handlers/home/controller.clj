(ns mrp.handlers.home.controller
  (:require
   [buddy.hashers :as hashers]
   [clojure.string :as st]
   [mrp.config.loader :as cfg]
   [mrp.i18n.core :as i18n]
   [mrp.handlers.home.model :refer [get-user get-users update-password]]
   [mrp.handlers.home.view :refer [change-password-view forgot-password-view home-view main-view
                                    temp-password-view]]
   [mrp.layout :refer [application]]
   [mrp.models.email :as email]
   [mrp.models.util :refer [get-session-id user-auth]]
