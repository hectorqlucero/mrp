(ns mrp.handlers.reports.view
  (:require
   [mrp.models.grid :refer [build-report]]
...
(defn inventory
  [request title rows]
  (build-report request title rows "inventory-report" inventory-fields))

(def ^:private bom-cost-fields
  (array-map
   :producto_codigo "Código"
   :producto_nombre "Producto"
   :bom_codigo "BOM"
   :num_materiales "# Materiales"
...
(defn bom-cost
  [request title rows]
  (build-report request title rows "bom-cost-report" bom-cost-fields))

(def ^:private purchase-status-fields
  (array-map
   :codigo "OC"
   :proveedor "Proveedor"
   :fecha "Fecha"
...
(defn purchase-status
  [request title rows]
  (build-report request title rows "purchase-status-report" purchase-status-fields))
