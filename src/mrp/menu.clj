...
;;     :order 40
;;     :icon "bi bi-printer"
;;     :items [["/reports/mrp" "Contactos"  "U" 10 "bi bi-people"]
...
(def custom-dropdowns
  ...
  {:Reports
   {:id "navdrop-reports"
    ...
    :order 30
    :icon "bi bi-printer"
    :items [["/reports/audit-log" "Auditoría" "U" 40 "bi bi-journal-text"]
             ["/reports/users" "Usuarios" "A" 50 "bi bi-people"]
             ["/reports/inventory" "Inventario" "U" 60 "bi bi-box-seam"]
             ["/reports/bom-cost" "Costos BOM" "U" 70 "bi bi-calculator"]
             ["/reports/purchase-status" "Compras" "U" 80 "bi bi-truck"]]}})
...
(def custom-dropdown-items
  ...
  {:Users [["/home/temp-password" :nav/tp "A" 10 "bi bi-file-text"]]
   :MRP [["/mrp/explosion" :mrp/explosion "U" 5 "bi bi-cpu"]]})
