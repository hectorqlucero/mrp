(ns mrp.core
  (:require
   ...
   [mrp.models.crud :refer [config KEY]]
   [mrp.routes.proutes :refer [proutes]]
   [mrp.routes.routes :refer [open-routes password-routes]]
   [mrp.routes.i18n :refer [i18n-routes]]
   [mrp.routes.tabgrid :refer [tabgrid-routes]]
   [mrp.routes.fk-api :refer [fk-api-routes]]
   [mrp.engine.router :as engine]
