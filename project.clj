(defproject mrp "0.1.0"
  ...
  :plugins [[lein-ancient "1.0.0"]
            [lein-pprint "1.3.2"]]
  :uberjar-name "mrp.jar"
  :target-path "target/%s"
  :ring {:handler mrp.core
         :auto-reload? true
         :auto-refresh? false}
  :resource-paths ["resources"]
  :aliases {"migrate"  ["run" "-m" "mrp.migrations/migrate" "--"]
            "rollback" ["run" "-m" "mrp.migrations/rollback" "--"]
            ...
            "database" ["run" "-m" "mrp.models.cdb/database" "--"]
            ;; Seed all tables except users
            ;;   lein seed-non-users
            ;;   lein seed-non-users pg
            ;;   lein seed-non-users localdb
            "seed-non-users" ["run" "-m" "mrp.models.cdb/seed-non-users" "--"]
            "scaffold" ["run" "-m" "mrp.engine.scaffold"]
            ...
            "convert-migrations" ["run" "-m" "mrp.db.converter" "--"]
            ...
            "copy-data" ["run" "-m" "mrp.db.migrator" "--"]
